  ...
  wayland.windowManager.hyprland.settings = {
    ...
    bind =
      [
        ...
        ''$mods, U, exec, [workspace 1 silent; float; size 858 462; move 640 609] $term --window-padding-x=0 --window-padding-y=0 --font-size=3 -e cava -p "$XDG_CONFIG_HOME"/cava/vcConfig''
