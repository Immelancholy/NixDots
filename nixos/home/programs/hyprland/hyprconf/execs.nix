{config, ...}: {
  wayland.windowManager.hyprland.settings = {
    exec-once = [
      ...
      ''[workspace 1 silent; float; size 858 462; move 640 609] $term cava.sh''
      ''[workspace 1 silent; float; size 620 637; move 10 433] $term btop.sh''
      ''[workspace 1 silent; float; size 402 1030; move 1508 42] $term neo.sh''
